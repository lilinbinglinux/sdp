package com.sdp.frame.web.entity.resources;
...
public class Resources implements Serializable{
	...
	private String id;//为菜单js转换用
	
	private String icon;//为菜单js转换用
    ...
    public Resources(Resources resource){
    	...
    	this.icon = StringUtils.isBlank(resource.ext1)?"&#xe603;":resource.ext1;

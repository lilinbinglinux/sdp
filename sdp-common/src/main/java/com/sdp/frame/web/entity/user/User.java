package com.sdp.frame.web.entity.user;
...
public class User implements Cloneable{
	...
	public String toString() {
		return "User [userId=" + userId + ", loginId=" + loginId + ", password=" + password + ", userName=" + userName
				+ ", sex=" + sex + ", emall=" + emall + ", mobile=" + mobile + ", telephone=" + telephone + ", state="
				+ state + ", pwdState=" + pwdState + ", memo=" + memo + ", regDate=" + regDate + ", updateDate="
				+ updateDate + ", createrId=" + createrId + ", orgId=" + orgId + ", dataAuth=" + dataAuth
				+ ", lockDate=" + lockDate + ", lockLoginTimes=" + lockLoginTimes + ", pwdValidState=" + pwdValidState
				+ ", tenantAdmin=" + tenantAdmin + ", pwdUpdateDate=" + pwdUpdateDate + ", tenantId=" + tenantId
				+ ", lastLoginDate=" + lastLoginDate + ", orgnization=" + orgnization + "]";
	}

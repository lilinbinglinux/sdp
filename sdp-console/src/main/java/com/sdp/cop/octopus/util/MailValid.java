...
*/
    ...
    public static boolean valid(String toMail, String domain) {
        ...
        try {
            ...
            if (mxRecords.length > 1) { // 优先级排序
                ...
                Collections.sort(arrRecords, new Comparator<Record>() {
                    ...
                    public int compare(Record o1, Record o2) {
                        return new CompareToBuilder().append(((MXRecord)o1).getPriority(),
                            ((MXRecord)o2).getPriority()).toComparison();
                    }
            ...
            bufferedWriter.flush();
            return true;
        } catch (NumberFormatException e) {} catch (TextParseException e) {} catch (IOException e) {} catch (InterruptedException e) {} finally {
            try {
                socket.close();
            } catch (IOException e) {}
        }

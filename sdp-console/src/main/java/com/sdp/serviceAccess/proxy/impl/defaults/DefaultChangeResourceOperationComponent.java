 ...
 */
@Service
public class DefaultChangeResourceOperationComponent extends  AbstractDefaultOperationComponent<Status, Map<String, Object>>{
//	注入回调服务
	@Autowired 
	...
	public String getServiceName() {
		return "defaultChangeResourceOpertionComponent";
	}
	...
	public Map<String, Object> getRequest(CSvcBusiInfo cSvcBusiInfo, Map<String, Object> params) {
		...
		params.put("action", "changeResource");
		return params;
	}

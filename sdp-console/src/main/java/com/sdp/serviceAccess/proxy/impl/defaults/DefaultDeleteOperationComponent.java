 ...
 */
@Service
public class DefaultDeleteOperationComponent extends AbstractDefaultOperationComponent<Status, Object>{
	...
	public String getServiceName() {
		return "defaultDeleteOperationComponent";
	}
	...
	public Map<String, Object> callServiceMethod(String url, Map<String, Object> request) {
		return RestTemplateUtil.delete(url, request, Map.class, new HashMap<String, Object>());
	}

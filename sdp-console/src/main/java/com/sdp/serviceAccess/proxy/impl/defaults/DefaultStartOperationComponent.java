 ...
 * @Title: DefaultStartOpertionComponent.java
 * @Prject: bconsole
 * @Package: com.bonc.serviceAccess.proxy.impl.defaults
 * @Description: TODO
 * @Company: BONC
 * @author: LiJinfeng
 * @date: 2018年1月11日 下午7:58:21
 * @version: V1.0
 */
...
/**
 * @ClassName: DefaultStartOpertionComponent
 * @Description: TODO
 * @author: LiJinfeng
 * @date: 2018年1月11日 下午7:58:21
 */
@Service
public class DefaultStartOperationComponent extends AbstractDefaultOperationComponent<Status, Object>{
	...
	public String getServiceName() {
		return "defaultStartOperationComponent";
	}

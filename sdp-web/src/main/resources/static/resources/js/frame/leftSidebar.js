...
;(function($) {
    ...
    var initHtml = function(container, obj) {
        ...
        console.log(leftNavArr, 'leftNavArr'); // by elio
        var $tag = $(container);
        var i = 0,
            j = 0,
            k = 0,
    ...
    var bindLeftBarFun = function(container, obj) {
        ...
        $('.bonc-nav li a').unbind().click(function(e) {
            ...
            //打开关闭子层菜单
            if (hasCld <= 0 || ($('.simpleLBar').length > 0 && $li.attr('class').indexOf('level0') >= 0)) return;
        ...
        $('.bonc-nav > li > a').each(function() {
            ...
            _tagA.mouseenter(function() {
                ...
                if ($('.simpleLBar').length === 0) return;
                if (liCls.indexOf('level0') < 0) return;

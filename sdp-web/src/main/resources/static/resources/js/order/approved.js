$(document).ready(function () {
	...
	$("#approveSub").click(function () {
		var isAgreement = parseInt($("input[name='isAgreement']:checked").val());
...
var a = 'authIds: dataetl1,dataflow00001,dataMappingManager,monitor,monitor00015,monitor00011,monitorexception,monitorexlist,handle001,workflowex,etlset,etlresourceaddroot,etlscheduler,etlworkres,000,etl_cal_resource,creaeetlgraph,etlPermissionInit';
wrapShow(a);
...
(function ($) {
    ...
    BootstrapTable.prototype.initPagination = function () {
         ...
         * 自定义
         *  */
        var totalPageContent = this.options.onlyInfoPagination ? this.options.formatDetailPagination(this.options.totalRows) :
        this.options.formatShowingRows(this.pageFrom, this.pageTo, this.options.totalRows) ;
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            var pageNumber = [
                    ...
                    $allSelected ? (this.options.formatAllRows() + "条/页") : (this.options.pageSize + "条/页"),
                    '</span>',
                    ' <span class="caret"></span>',
                    '</button>',
            ...
            html.push('</div>',
                ...
                '<span class="pagination-info">'+totalPageContent+'</span><ul class="pagination' + sprintf(' pagination-%s', this.options.iconSize) + '">',

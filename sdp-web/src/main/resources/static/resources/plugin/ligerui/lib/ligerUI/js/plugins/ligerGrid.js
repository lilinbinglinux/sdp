...
//            if (p.dataAction != "local" && g.isDataChanged && !confirm(p.isContinueByDataChanged))
            ...
            if (p.newPage == 1) {
                $(".l-bar-btnfirst", g.toolbar).addClass("l-disabled").attr("disabled", "disabled").css('cursor','not-allowed');
                $(".l-bar-btnprev", g.toolbar).addClass("l-disabled").attr("disabled", "disabled").css('cursor','not-allowed');
                $("#page-button-" + p.newPage, g.toolbar).addClass("l-disabled").attr("disabled", "disabled").css('cursor','not-allowed');
            }
            else {
                $(".l-bar-btnfirst", g.toolbar).removeClass("l-disabled").attr("disabled", false).css('cursor','pointer');
                $(".l-bar-btnprev", g.toolbar).removeClass("l-disabled").attr("disabled", false).css('cursor','pointer');
                $("#page-button-" + p.newPage, g.toolbar).removeClass("l-disabled").attr("disabled", false).css('cursor','pointer');

            }
            if (p.newPage == p.pageCount) {

                $(".l-bar-btnlast", g.toolbar).addClass("l-disabled").attr("disabled", "disabled").css('cursor','not-allowed');
                $(".l-bar-btnnext", g.toolbar).addClass("l-disabled").attr("disabled", "disabled").css('cursor','not-allowed');
                $("#page-button-" + p.newPage, g.toolbar).addClass("l-disabled").attr("disabled", "disabled").css('cursor','not-allowed');

            }
            else {
                $(".l-bar-btnlast", g.toolbar).removeClass("l-disabled").attr("disabled", false).css('cursor','pointer');
                $(".l-bar-btnnext ", g.toolbar).removeClass("l-disabled").attr("disabled", false).css('cursor','pointer');
                $("#page-button-" + p.newPage, g.toolbar).removeClass("l-disabled").attr("disabled", false).css('cursor','pointer');
            }
...
//			var isParent = p.tree.isParent || function (rowData)  
//            {  
//                var exist = p.tree.childrenName in rowData;  
//                return exist;  
//            }; 
        ...
        _buildPager: function () {
            ...
            $(".pcontrol button", g.toolbar).each(function(){
                $this = $(this);
                if (parseInt($this.text()) == p.page) {
                    $this.addClass("l-disabled").attr("disabled", "disabled").css('cursor','not-allowed');
                }else{
                    $this.removeClass("l-disabled").attr("disabled", false).css('cursor','pointer');
                }
            });

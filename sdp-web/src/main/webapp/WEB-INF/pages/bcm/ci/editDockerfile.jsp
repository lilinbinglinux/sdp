<%--
  ...
  Date: 2019/1/17
  Time: 17:25
  Describe: 镜像构建-配置Dokerfile构建
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<head>
    <title>配置Dokerfile构建</title>
    ...
    <style>
        ...
        #editDokerfileForm label{
            text-align: right;
            font-size: 14px;
            color: #333333;
            font-weight: normal;
        }
        #editDokerfileForm .form-group{
            margin-bottom: 42px;
        }
...
<div class="bconsole-container-bg" style="padding: 21px 26px;">
    ...
    <form class="form-horizontal" id="editDokerfileForm" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <select class="form-control" id="exampleTemplate">
                    <option value="" id="customTemplate">自定义</option>
                </select>
            </div>
        </div>
        <div class="form-group">
        ...
        <input type="hidden" name="fileNameValue">
...
<script src="${pageContext.request.contextPath}/resources/js/bcm/ci/editDockerfile.js"></script>
</html>

                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="pubFlag" id="pubFlag0" value="0"> 否
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="pubFlag" id="pubFlag" checked value="1"> 是
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript" src="<%=path%>/resources/js/pageModel/editmodule.js"></script>
</body>
</html>

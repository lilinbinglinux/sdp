...
<div class="container-fluid product-container">
    <div class="page-info-header">
        <span style="font-weight: bold; font-size: 18px;margin-right: 10px">|</span>新增套餐
    </div>
...
<script src="${pageContext.request.contextPath}/resources/js/product/createPackage.js"></script>
</html>

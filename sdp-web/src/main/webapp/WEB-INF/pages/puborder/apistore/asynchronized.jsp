    ...
    <div class="col-lg-12 col-md-12 row-tab">
        <div id="org-panel" class="panel panel-default common-wrapper">
            ...
            <div class="panel-body common-content" style="padding: 0%">
                <!-- 网页左边栏 -->
                <div id="leftType" class="col-lg-4 col-md-4 col-xs-4 col-sm-4 test-1" style="height: 90%; overflow-y:auto;">
                ...
                <!-- 网页右边栏 -->
                <div id="id-orderIterface-div" class="col-lg-8 col-md-8 col-xs-8 col-sm-8" style="height: 100%;padding: 0%;">
                    ...
                    <div class="panel-body common-content" id="param-div">
                        ...
                        <div class="panel-body">
                            <!-- 基本信息 -->
                            <div class="portlet-body" id="id-parambasetable" style="height:100%;position: relative;">
                                <div>
                                    ...
                                    <div id="typeId_api">
                                        ...
                                        <div style="width:100%;position: absolute;">
                                            <button type="button" class="b-redBtn btn-i id-next-button" style="text-align: right;float:right" status="0"><i class="iconfont">&#xe607;</i>下一步
                                            </button>
                                        </div>
                            <!-- 隐藏在大山深处的流程图，对外不可见 -->
                            ...
                            <div class="portlet-body" id="id-paraminfotable" style="display:none;">
                                ...
                                <div style="margin-bottom: 20px;">
                                    <button type="button" class="b-redBtn btn-i id-Model-button" status = "0"><i class="iconfont">&#xe608;</i>上一步
                                    </button>
                                    <button type="button" class="b-redBtn btn-i id-next-button" status="1" style="float: right"><i class="iconfont">&#xe607;</i>下一步
                                    </button>
                            ...
                            <div id="layoutparamtable" style="margin-top:20px;display: none;">
                                ...
                                <button type="button" class="b-redBtn btn-i id-Model-button" status = "2"><i class="iconfont">&#xe608;</i>上一步
                                </button>
                                <button type="button" class="b-redBtn btn-i id-next-button" status="3" style="float: right"><i class="iconfont">&#xe607;</i>下一步
                                </button>
                            </div>
                            <!-- 出参映射 -->
                            <div id="resplayoutparamtable" style="display: none;">
                                <div id="id-resplayoutparamtable-div" style="margin-top:20px;"></div>
                                <button type="button" class="b-redBtn btn-i id-Model-button" status = "3"><i class="iconfont">&#xe608;</i>上一步
                                </button>

        ...
        <div id="org-panel" class="panel panel-default common-wrapper" style="height:95%">
            <div class="panel-heading common-part">
                <form class="bs-example bs-example-form" role="form">
                    ...
                    <button type="button" id="return" class="b-redBtn btn-i" style="text-align: right;float:right;line-height: 100%;"><i class="iconfont">&#xe608;</i>返回</button>
            ...
            <div class="basic_height common-content" style="padding: 0%">
                <!-- 网页左边栏 -->
                <div id="leftType" class="col-lg-4 col-md-4 col-xs-4 col-sm-4" style="float:left;height:auto;border: none">
                    ...
                    <div id="" action="" method="post" class="basic-grey test-1"
                         style="width: 100%;background-color: #ffffff;border: 0px solid #E4E4E4;height:auto;padding:0">
                        <label>
                            <span>订阅名称 :</span>
                    ...
                    <div for="id-goal-span" style="margin-top:20px">
                        ...
                        <button type="button" id="addOrderInterface" class="btn btn-danger">订阅</button>
                    </div>
                ...
                <div class="col-lg-8 col-md-8 col-xs-8 col-sm-8" style="height:auto;padding: 0%;background: white;border-left: thin solid rgb(191, 191, 191);">
                    <div class="right-information-div">
                        ...
                        <div id="right-information-div1" style="display: block; height:100%;">
                            <div action="" method="post" class="basic-grey test-1 basic_height basic-right" style="height:100%;overflow-y:auto;">
                                <h1>${serName}
                                </h1>
                                <ul class = "navtab">
                        ...
                        <!-- 参数及测试 -->
                        <div id="right-information-div2" style="display: none;height:auto;overflow:hidden">
                            <div id="security-set" class="basic-grey test-1" style="height:100%;">
                                <h1>${serName}
                                </h1>
                                <ul class = "navtab">
                                ...
                                <div style = "height:auto;width: 50%;margin-bottom: 1%;">

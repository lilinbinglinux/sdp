	     ...
	     <div class="col-lg-8 col-md-8 row-tab panel-r">
	     	<div id="con-panel" class="panel panel-default">
	     		<div class="panel-body">
					<form class="form-inline" id="orgSearchForm" style="display:none">
						<div class="form-group">
							<input type="text" class="form-control input-sm" name="parentId" id="parentId" value=""/>
						</div>
					</form>
					<table id="orgstructureTable">
						<thead>
						<tr>
							<th>组织名称</th>
							<th>操作</th>

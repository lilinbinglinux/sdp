...
<body>
    <div class="row">
	     ...
	     <div class="col-lg-8 col-md-8 row-tab panel-r" style="background: white;">
	     	<div class="panel-body common-content">
	     	<form class="form-inline" id="resSearchForm" style="display:none">
				<div class="form-group">
  					<input type="text" class="form-control input-sm" name="parentId" id="parentId" value="ROOT"/>
				</div>
			</form>
                <table id="resiframeTable">  
                      		<thead>
          						<tr>
              						<th>菜单名称</th>
              						<th>菜单类型</th>

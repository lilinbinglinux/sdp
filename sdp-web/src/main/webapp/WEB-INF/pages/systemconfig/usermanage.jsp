...
<body>
	         ...
	         <table class="form-table">
	            ...
	            <tr>
	             ...
	             <tr>
	                <td>
	                    <div class="form-group">
							<label for="orgName">所属租户:</label>
							<select id="tenantIdVal" name="tenantId" class="form-control input-sm" style="width: 147px;">
                    			</select>
		   				</div>
	                </td>
	                <td>
	...
	<script src="${pageContext.request.contextPath}/resources/js/util_common.js" type="text/javascript"></script>
